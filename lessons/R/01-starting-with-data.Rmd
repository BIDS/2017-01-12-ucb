...
```{r, results="hide"}
read.csv(file = "~/Dropbox/2017-01-12-ucb/data/data-files/r-lesson/data/inflammation-01.csv", header = FALSE)
```
...
```{r}
dat <- read.csv(file = "~/Dropbox/2017-01-12-ucb/data/data-files/r-lesson/data/inflammation-01.csv", header = FALSE)
```
